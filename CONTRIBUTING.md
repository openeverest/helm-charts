...
You are reading `v1.x`. On 18 August 2026 the two lines swapped branches: v2
moved from `v2` to `main`, and v1 moved here. Both lines are still developed;
only the branch names changed. The
