...
You are reading the `v1.x` branch, which carries the chart for OpenEverest v1.
Current development happens on `main`, which carries the v2 chart. Target
`v1.x` only for fixes to the 1.x line.
